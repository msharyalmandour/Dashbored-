...
function SupervisorLinkCard() {
  ...
  const copyReminder = async () => {
    const message = team.supervisorNote
      ...
      : `مرحبًا دكتور/ة، جهّزنا رابط متابعة لتقدم فريقنا البحثي على StudySync — نكون شاكرين لو تقدرون تطّلعون عليه وتتركون لنا ملاحظتكم:\n${shareLink}`;
...
function ReferralCard() {
  ...
  const waMessage = `جربوا StudySync — منصة تنظّم بحث التخرج كامل بمكان واحد. سجّلوا من هذا الرابط وابدأوا تجربة ٧ أيام مجانية 🎁\n${referralLink}`;
